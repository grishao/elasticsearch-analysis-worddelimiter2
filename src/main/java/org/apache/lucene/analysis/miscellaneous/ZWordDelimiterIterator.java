...
/**
* I Dont know why, but if we use lucene class we have error while instantiating the class, the same with accessing methods in WordDelimiterFilter class
* Caused by: ElasticsearchException[tried to access method org.apache.lucene.analysis.miscellaneous.WordDelimiterIterator.<init>([BZZZ)V from class org.apache.lucene.analysis.miscellaneous.WordDelimiterFilter2];
*/

import static org.apache.lucene.analysis.miscellaneous.ZWordDelimiterFilter.*;

/**
 * A BreakIterator-like API for iterating over subwords in text, according to WordDelimiterFilter rules.
 * @lucene.internal
 */
public final class ZWordDelimiterIterator {
   ...
   */
  ZWordDelimiterIterator(byte[] charTypeTable, boolean splitOnCaseChange, boolean splitOnNumerics, boolean stemEnglishPossessive) {
