 ...
 */
public final class ZWordDelimiterFilter extends TokenFilter {
   ...
   */
  public ZWordDelimiterFilter(TokenStream in, byte[] charTypeTable, int configurationFlags, CharArraySet protWords) {
    super(in);
    this.flags = configurationFlags;
    this.protWords = protWords;
    this.iterator = new ZWordDelimiterIterator(
   ...
   * @param protWords If not null is the set of tokens to protect from being delimited
   */
  public ZWordDelimiterFilter(TokenStream in, int configurationFlags, CharArraySet protWords) {
